...
| 031 | [Reusable canvas component (contract editor & workflow editor)](031-reusable-canvas-component.md) | Proposed | 2026-05-26 | v2.x | — | canvas, svelte-flow, reuse, perspecta-workflows, component-seam, editor, cross-repo |
